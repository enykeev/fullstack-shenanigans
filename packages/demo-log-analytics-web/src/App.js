  ...
  return (
    <div className="TimeRangesDropdown">
      ...
      {TIME_RANGES.map((range) => (
        <button
          key={range.label}
          className="TimeRangesDropdown__button"
...
function TimeRanges() {
  ...
  return (
    <div className="TimeRanges">
      ...
      {showDropdown && (
        <TimeRangesDropdown onSelect={handleSelect} onCancel={handleCancel} />
      )}
    </div>
  );
}
        ...
        >
          ...
          >
            <div className="LoginModal__header">
              ...
              <div className="LoginModal__close" onClick={() => onCancel()}>
                X
              </div>
            </div>
  ...
  return (
    <div className="LocaleDropdown">
      ...
      {Object.keys(LOCALES).map((key) => (
        <button
          key={key}
          className="LocaleDropdown__button"
...
function Header() {
  ...
  return (
    <div className="Header">
      ...
      {showLoginModal && (
        <LoginModal onSubmit={handleLoginSubmit} onCancel={handleLoginCancel} />
      )}
      {showLanguageDropdown && (
        <LocaleDropdown
          onSelect={handleLocaleSelect}
          onCancel={handleLocaleCancel}
        />
      )}
    </div>
  );
